...
class ForkLiftDemo : public CommonRigidBodyBase
{
public:
...
{
	ForkLiftDemo* info = (ForkLiftDemo*)world->getWorldUserInfo();
	info->setTargets();
...
void ForkLiftDemo::spawnEnvironment()
{
	// add ground
...
void ForkLiftDemo::spawnVehicle(btVector3 chassisHalfExtents, btScalar chassisMass, btScalar wheelRadius, btScalar wheelWidth, btScalar wheelMass, btScalar suspensionStiffness, btScalar suspensionDamping)
{
	...
	btRigidBody* chassisBody = createRigidBody(chassisMass, chassisTran, chassisShape); 
	m_vehicleRaycaster = new btDefaultVehicleRaycaster(m_dynamicsWorld);
	m_vehicle = new btRaycastVehicle(chassisBody, m_vehicleRaycaster);
...
void ForkLiftDemo::spawnForkLift()
{
